...
MOTION_FILE = os.path.join(os.path.dirname(__file__), "..", "..", "..", "..", "..", "..", "..", "..", "..", "k1_strong_instep_shoot_L.npz")
...
class FlatEnvCfg(TrackingEnvCfg):
    def __post_init__(self):
        ...
        self.commands.motion.tail_len = 10
        self.commands.motion.use_motion_xy_anchor = True
