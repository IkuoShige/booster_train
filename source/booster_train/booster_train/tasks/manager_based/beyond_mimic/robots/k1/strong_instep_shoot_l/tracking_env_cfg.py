...
class RewardsCfg:
    ...
    foot_contact_mismatch = RewTerm(
        func=mdp.motion_foot_contact_mismatch,
        weight=-30.0,
        params={
            "command_name": "motion",
            ...
            "motion_foot_z_threshold": 0.02,
            "force_clip": 50.0,
        },
    )

    arm_joint_pos = RewTerm(
...
class TerminationsCfg:
    ...
    anchor_ori = DoneTerm(
        ...
        params={"asset_cfg": SceneEntityCfg("robot"), "command_name": "motion", "threshold": 1.3},
    )
